...
<?php $__env->startSection('description', Str::limit($news->short_description, 160)); ?>

<?php $__env->startSection('schema_org'); ?>
    <?php if($news->video_iframe): ?>
        <?php echo $__env->make('schema_org.video_news_schema', ['news' => $news], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php else: ?>
        <script type="application/ld+json">
        {
            ...
            "description": "<?php echo e(Str::limit($news->short_description, 160)); ?>",
            "image": [
                "<?php echo e($news->image_url ? asset('uploads/' . $news->image_url) : asset('images/news-placeholder.jpg')); ?>"
            ],
            "datePublished": "<?php echo e($news->created_at->toIso8601String()); ?>",
...
<?php $__env->startSection('meta_tags'); ?>
    <?php if($news->video_iframe): ?>
        <?php echo $__env->make('seo.video_news_seo', ['news' => $news], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php else: ?>
        <meta property="og:article:published_time" content="<?php echo e($news->created_at->toIso8601String()); ?>">
        <meta property="og:article:modified_time" content="<?php echo e($news->updated_at->toIso8601String()); ?>">
        <meta property="og:article:author" content="<?php echo e($news->user ? $news->user->name : config('app.name')); ?>">
        <meta property="og:article:section" content="Кулинария">
        <meta name="twitter:label1" content="Время чтения">
        <meta name="twitter:data1" content="<?php echo e($readingTime); ?> минут">
    <?php endif; ?>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('breadcrumbs'); ?>
<li class="breadcrumb-item" itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
    <a href="<?php echo e(route('news.index')); ?>" itemprop="item">
        <span itemprop="name">Новости</span>
    </a>
    <meta itemprop="position" content="2" />
</li>
<li class="breadcrumb-item active" itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
    <span itemprop="name"><?php echo e($news->title); ?></span>
...
<div class="container py-4">
    <article class="news-article" itemscope itemtype="https://schema.org/NewsArticle">
        <meta itemprop="datePublished" content="<?php echo e($news->created_at->toIso8601String()); ?>">
        <meta itemprop="dateModified" content="<?php echo e($news->updated_at->toIso8601String()); ?>">
        <meta itemprop="headline" content="<?php echo e($news->title); ?>">
        <link itemprop="mainEntityOfPage" href="<?php echo e(url()->current()); ?>">
        <span itemprop="publisher" itemscope itemtype="https://schema.org/Organization">
            <meta itemprop="name" content="<?php echo e(config('app.name')); ?>">
            <span itemprop="logo" itemscope itemtype="https://schema.org/ImageObject">
                <meta itemprop="url" content="<?php echo e(asset('images/logo.png')); ?>">
            </span>
        </span>
        
        <header class="mb-4">
            <h1 class="display-5 fw-bold" itemprop="headline"><?php echo e($news->title); ?></h1>
            <div class="d-flex flex-wrap justify-content-between align-items-center text-muted mb-3">
                <div class="d-flex align-items-center">
                    <span class="me-3">
                        <i class="far fa-calendar-alt"></i> 
                        <time itemprop="datePublished" datetime="<?php echo e($news->created_at->toIso8601String()); ?>">
                            <?php echo e($news->created_at->format('d.m.Y')); ?>

                        </time>
                    </span>
                    <span class="me-3">
                        <i class="far fa-eye"></i> <span itemprop="interactionCount" content="UserPageVisits:<?php echo e($news->views); ?>"><?php echo e($news->views); ?></span> просмотров
                    </span>
                    <span>
                        <i class="far fa-clock"></i> <meta itemprop="timeRequired" content="PT<?php echo e($readingTime); ?>M"><?php echo e($readingTime); ?> мин. чтения
                    </span>
                </div>
                ...
                <div class="share-buttons mt-2 mt-md-0">
                    ...
                    <a href="https://vk.com/share.php?url=<?php echo e(urlencode(url()->current())); ?>" target="_blank" class="text-primary mx-1" aria-label="Поделиться ВКонтакте">
                        <i class="fab fa-vk fa-lg"></i>
                    </a>
                    <a href="https://t.me/share/url?url=<?php echo e(urlencode(url()->current())); ?>&text=<?php echo e(urlencode($news->title)); ?>" target="_blank" class="text-info mx-1" aria-label="Поделиться в Telegram">
                        <i class="fab fa-telegram fa-lg"></i>
                    </a>
                    <a href="https://connect.ok.ru/offer?url=<?php echo e(urlencode(url()->current())); ?>&title=<?php echo e(urlencode($news->title)); ?>" target="_blank" class="text-warning mx-1" aria-label="Поделиться в Одноклассниках">
                        <i class="fab fa-odnoklassniki fa-lg"></i>
                    </a>
                    <a href="https://api.whatsapp.com/send?text=<?php echo e(urlencode($news->title . ' ' . url()->current())); ?>" target="_blank" class="text-success mx-1" aria-label="Поделиться в WhatsApp">
            ...
            <div class="news-tags mb-4" itemprop="keywords">
                <a href="<?php echo e(route('news.index', ['search' => 'кулинария'])); ?>" class="badge bg-light text-dark text-decoration-none me-1">Кулинария</a>
                <a href="<?php echo e(route('news.index', ['search' => 'рецепты'])); ?>" class="badge bg-light text-dark text-decoration-none me-1">Рецепты</a>
                <a href="<?php echo e(route('news.index', ['search' => 'новости'])); ?>" class="badge bg-light text-dark text-decoration-none">Новости</a>
            </div>
        </header>
        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="text-center mb-4">
                    <img src="<?php echo e($news->getImageUrl()); ?>" 
                ...
                <!-- Видео, если есть -->
                <?php if($news->hasVideo()): ?>
                <div class="video-container mb-4">
                    <?php echo $news->video_iframe; ?>
                    ...
                    <div class="related-news-mobile mb-4">
                        ...
                        <div class="list-group">
                            <?php $__currentLoopData = $relatedNews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a href="<?php echo e(route('news.show', $item->slug)); ?>" class="list-group-item list-group-item-action">
                    ...
                    <div class="news-author card mb-4">
                        <div class="card-body d-flex align-items-center" itemprop="author" itemscope itemtype="https://schema.org/Person">
                            <div class="author-avatar me-3">
                                <img src="<?php echo e($news->user->avatar ?? asset('images/default-avatar.png')); ?>" 
                                    class="rounded-circle" width="60" height="60" 
                                    alt="<?php echo e($news->user->name); ?>" 
                                    itemprop="image">
                            </div>
                            <div>
                                <h5 class="mb-1" itemprop="name"><?php echo e($news->user->name); ?></h5>
                                <p class="text-muted mb-0" itemprop="description"><?php echo e($news->user->bio ?? 'Автор кулинарных статей'); ?></p>
                            </div>
                        </div>
                    </div>
                <?php endif; ?>
                ...
                <div class="news-navigation d-flex justify-content-between mt-5">
                    <div>
                        <?php if($prevNews): ?>
                            <a href="<?php echo e(route('news.show', $prevNews->slug)); ?>" class="btn btn-outline-primary">
                    ...
                    <div>
                        <?php if($nextNews): ?>
                            <a href="<?php echo e(route('news.show', $nextNews->slug)); ?>" class="btn btn-outline-primary">
                ...
                <div class="comments-section mt-5 pt-4 border-top">
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        <div class="card mb-4 comment-form-card">
                            <div class="card-body">
                                <form id="comment-form" action="<?php echo e(route('news.comments.store')); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                    ...
                    <?php else: ?>
                        <div class="alert alert-info d-flex align-items-center">
                            ...
                            <div>
                                Чтобы оставить комментарий, пожалуйста, <a href="<?php echo e(route('login')); ?>" class="fw-bold">войдите</a> или <a href="<?php echo e(route('register')); ?>" class="fw-bold">зарегистрируйтесь</a>.
                            </div>
                        </div>
                    <?php endif; ?>
                    ...
                    <div id="comments-list" class="comments-container">
                        <?php if(isset($comments) && $comments instanceof \Illuminate\Support\Collection && $comments->count() > 0): ?>
                            <?php $__currentLoopData = $comments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="comment-item card mb-3">
                                <div class="card-body">
                                    <div class="d-flex">
                                        <img src="<?php echo e(isset($comment->user) && $comment->user->avatar ? asset($comment->user->avatar) : asset('images/default-avatar.png')); ?>" 
                                            alt="<?php echo e(isset($comment->user) ? $comment->user->name : 'Пользователь'); ?>" 
                                            class="rounded-circle me-3" 
                                            width="50" height="50">
                                        <div class="w-100">
                                            <div class="d-flex justify-content-between align-items-center mb-2">
                                                <h6 class="card-subtitle mb-0 fw-bold"><?php echo e(isset($comment->user) ? $comment->user->name : 'Пользователь'); ?></h6>
                                                <small class="text-muted"><?php echo e($comment->created_at->diffForHumans()); ?></small>
                                            </div>
                                            <p class="card-text"><?php echo e($comment->content); ?></p>
                                            <?php if(Auth::check() && (Auth::id() == $comment->user_id || (Auth::user()->isAdmin && Auth::user()->isAdmin()))): ?>
                                            <div class="text-end">
                                                <form action="<?php echo e(route('news.comments.destroy', $comment->id)); ?>" method="POST" class="d-inline">
                                                    <?php echo csrf_field(); ?>
            ...
            <div class="col-lg-4">
                ...
                <div class="card mb-4">
                    ...
                    <div class="list-group list-group-flush">
                        ...
                        <a href="<?php echo e(route('recipes.show', $recipe->slug)); ?>" class="list-group-item list-group-item-action d-flex align-items-center">
                            <?php if($recipe->image): ?>
                                <img src="<?php echo e(asset($recipe->image)); ?>" alt="<?php echo e($recipe->title); ?>" class="me-3" 
                                     style="width: 70px; height: 70px; object-fit: cover; border-radius: 4px;">
                            <?php endif; ?>
                            <div>
                                <h6 class="mb-1"><?php echo e(Str::limit($recipe->title, 40)); ?></h6>
                                <div class="d-flex align-items-center">
                                    <span class="badge bg-warning text-dark me-2">
                                        <i class="fas fa-star me-1"></i><?php echo e(number_format($recipe->rating_avg ?? 4.5, 1)); ?>

                                    </span>
                                    <small class="text-muted"><?php echo e($recipe->cooking_time ?? '30 мин'); ?></small>
                                </div>
                            </div>
                        </a>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="related-news d-none d-lg-block">
                    <div class="card">
                        ...
                        <div class="card-body p-0">
                            <?php $__currentLoopData = $relatedNews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a href="<?php echo e(route('news.show', $item->slug)); ?>" class="text-decoration-none">
                                    <div class="d-flex align-items-center p-3 border-bottom">
                                        ...
                                        <?php endif; ?>
                                        <div>
                                            <h6 class="mb-1 text-dark"><?php echo e(Str::limit($item->title, 60)); ?></h6>
                                            <div class="d-flex align-items-center text-muted small">
                                                <i class="far fa-calendar-alt me-1"></i>
                                                <span><?php echo e($item->created_at->format('d.m.Y')); ?></span>
                                                <span class="mx-2">•</span>
                                                <i class="far fa-eye me-1"></i>
                                                <span><?php echo e($item->views); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                </a>
                ...
                <div class="card mt-4">
                    ...
                    <div class="list-group list-group-flush">
                        <a href="<?php echo e(route('recipes.index')); ?>" class="list-group-item list-group-item-action d-flex align-items-center">
                            <i class="fas fa-utensils me-2 text-primary"></i> Все рецепты
                        </a>
                        <a href="<?php echo e(route('categories.index')); ?>" class="list-group-item list-group-item-action d-flex align-items-center">
                            <i class="fas fa-list me-2 text-success"></i> Категории
                        </a>
                        <a href="<?php echo e(route('search')); ?>" class="list-group-item list-group-item-action d-flex align-items-center">
        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="d-grid gap-2 d-md-flex justify-content-md-center">
                    <a href="<?php echo e(route('news.index')); ?>" class="btn btn-primary btn-lg px-4 me-md-2">Больше новостей</a>
                    <a href="<?php echo e(route('recipes.index')); ?>" class="btn btn-outline-secondary btn-lg px-4">Перейти к рецептам</a>
                </div>
            </div>
        </div>
    </div>
            ...
            .then(data => {
                ...
                if (data.comment) {
                    ...
                    commentItem.innerHTML = `
                        <div class="card-body">
                            <div class="d-flex">
                                <img src="${data.userAvatar || '<?php echo e(asset("images/default-avatar.png")); ?>'}" 
                                    alt="${data.userName}" 
                                    class="rounded-circle me-3" 
                                    width="50" height="50">
                                <div class="w-100">
                                    ...
                                    <div class="text-end">
                                        <form action="<?php echo e(route('news.comments.destroy', '')); ?>/${data.comment.id}" method="POST" class="d-inline">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('DELETE'); ?>
                                            <button type="submit" class="btn btn-sm btn-outline-danger" onclick="return confirm('Вы уверены?')">
                                                <i class="far fa-trash-alt"></i> Удалить
...
<?php echo $__env->make('layouts.news', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\eats\resources\views/news/show.blade.php ENDPATH**/ ?>