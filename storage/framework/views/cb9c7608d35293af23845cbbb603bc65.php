...
<script type="application/ld+json">
    <?php echo json_encode($newsSchema, JSON_UNESCAPED_UNICODE | JSON_PRETTY_PRINT, 512) ?>
</script>

<script type="application/ld+json">
    <?php echo json_encode($breadcrumbSchema, JSON_UNESCAPED_UNICODE | JSON_PRETTY_PRINT, 512) ?>
</script>
...
<script type="application/ld+json">
{
    ...
    "potentialAction": {
        "@type": "SearchAction",
        "target": "<?php echo e(route('news.index')); ?>?search={search_term_string}",
        "query-input": "required name=search_term_string"
    }
}
</script>
<?php /**PATH C:\OSPanel\domains\eats\resources\views/schema_org/news_schema.blade.php ENDPATH**/ ?>