...
<head>
    ...
    <!-- Scripts -->
    <?php echo app('Illuminate\Foundation\Vite')(['resources/css/app.css', 'resources/css/pwa.css', 'resources/js/pwa.js', 'resources/js/app.js']); ?>
    ...
    <?php if(auth()->guard()->check()): ?>
        <?php if(auth()->user()->isAdmin()): ?>
            ...
            <script src="<?php echo e(asset('js/debug-tools.js')); ?>"></script>
        <?php endif; ?>
    <?php endif; ?>
    ...
    <link rel="preload" href="<?php echo e(asset('assets/fonts/fontawesome-webfont.woff2')); ?>" as="font"
    ...
    <?php if(isset($isRecipe) && $isRecipe && Route::has('recipes.amp')): ?>
        <link rel="amphtml" href="<?php echo e(route('recipes.amp', ['slug' => $recipe->slug])); ?>">
    <?php endif; ?>
    ...
    <script src="<?php echo e(asset('assets/js/scroll-top.js')); ?>" defer></script>
    <script src="<?php echo e(asset('assets/js/cookie-consent.js')); ?>" defer></script>
    <script src="<?php echo e(asset('assets/js/search.js')); ?>" defer></script>
    <script src="<?php echo e(asset('assets/js/pwa-installer.js')); ?>" defer></script>
    <script src="<?php echo e(asset('assets/js/random-images.js')); ?>" defer></script>
    <script src="<?php echo e(asset('assets/js/service-worker.js')); ?>" defer></script>
    <script src="<?php echo e(asset('assets/js/mobile-menu.js')); ?>" defer></script>
    <script src="<?php echo e(asset('assets/js/main.js')); ?>" defer></script>

    <!-- Обработчик изображений -->
    <script src="<?php echo e(asset('assets/js/image-loader.js')); ?>" defer></script>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const imgErrorHandler = function(event) {
                ...
                const isCategory = img.closest('.category-card') !== null || img.classList.contains(
                    'category-img');
                const placeholderPath = isCategory ? '/images/category-placeholder.jpg' :
    ...
    <script src="<?php echo e(asset('js/pwa-install-widget.js')); ?>" defer></script>
...
<?php echo $__env->make('partials.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\eats\resources\views/layouts/app.blade.php ENDPATH**/ ?>