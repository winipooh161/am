...
class SeoService
{
    ...
    {
        return [
            'title' => 'Лучшие кулинарные рецепты - пошаговые инструкции',
            'meta_description' => 'Кулинарные рецепты с пошаговыми инструкциями для приготовления вкусных и разнообразных блюд. Простые рецепты для домашней кухни.',
            'meta_keywords' => 'рецепты, кулинария, блюда, еда, готовка, кухня, приготовление',
            'canonical' => url('/'),
            'og_type' => 'website',
