    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            ...
            <div id="news-container" class="row view-grid" itemscope itemtype="https://schema.org/CollectionPage">
                @include('news.partials.news_items', ['news' => $news])
            </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="card mb-4 popular-news-card">
                ...
                <div class="list-group list-group-flush">
                    ...
                    <a href="{{ route('news.show', $item->slug) }}" class="list-group-item list-group-item-action d-flex align-items-center">
                        @if($item->image_url)
                            <img src="{{ asset('uploads/' . $item->image_url) }}" alt="{{ $item->title }}" class="me-3 popular-news-img" data-no-random>
                        @endif
                        <div>
                            <h6 class="mb-1">{{ Str::limit($item->title, 45) }}</h6>
                            <small class="text-muted">
                                <i class="far fa-eye me-1"></i> {{ $item->views }}
                                <i class="far fa-calendar-alt ms-2 me-1"></i> {{ $item->formatted_date }}
                            </small>
                        </div>
                    </a>
                    @endforeach
