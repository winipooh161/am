...
@section('seo')
    @include('seo.categories_index_seo', ['popularCategories' => $popularCategories, 'categoriesCount' => count($categoriesByLetter)])
@endsection

@section('title', $title ?? 'Все категории')
@section('description', $description ?? 'Список всех категорий на сайте')
@section('keywords', $keywords ?? 'категории, кулинария, список')
