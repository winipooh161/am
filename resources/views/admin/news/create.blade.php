                        ...
                        <div id="video-data-container">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('video_iframe') is-invalid @enderror" 
                                        id="video_iframe" name="video_iframe" rows="3" placeholder="Вставьте код iframe с ВКонтакте или Rutube">{{ old('video_iframe') }}</textarea>
                                <div class="form-text">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('video_author_name') is-invalid @enderror" 
                                        id="video_author_name" name="video_author_name" value="{{ old('video_author_name') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('video_description') is-invalid @enderror" 
                                        id="video_description" name="video_description" rows="3">{{ old('video_description') }}</textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control video-tags-input @error('video_tags') is-invalid @enderror" 
                                    id="video_tags" name="video_tags" value="{{ old('video_tags') }}" placeholder="Введите теги через запятую">
                                @error('video_tags')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
